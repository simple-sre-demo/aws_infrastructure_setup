resource "aws_iam_role" "eks_cluster_iam_role" {
  name = "${local.eks_cluster_name}-iam-role-cluster"
...
resource "aws_iam_role" "eks_nodes_iam_role" {
  name = "${local.eks_cluster_name}-iam-role-nodes"
...
resource "aws_iam_role_policy_attachment" "eks_ec2_container_registry_role_policy_attachment" {
